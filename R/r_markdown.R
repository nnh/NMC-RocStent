...
render(paste0(source_path, "/spo2.R"), output_dir=output_path)
render(paste0(source_path, "/completed.R"), output_dir=output_path)
render(paste0(source_path, "/gass.R"), output_dir=output_path)
