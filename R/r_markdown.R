...
render(paste0(source_path, "/sae.R"), output_dir=output_path, output_file="sae_fas.html")
render(paste0(source_path, "/spo2.R"), output_dir=output_path, output_file="spo2_fas.html")
render(paste0(source_path, "/completed.R"), output_dir=output_path, output_file="completed_fas.html")
